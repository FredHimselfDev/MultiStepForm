...
function prevNext(stepNb) {
  ...
  currentStep = currentStep + stepNb;
  showStep(currentStep);
}
...
function selectionName(option) {
  switch (option) {
    ...
    case 3:
      ...
      document.getElementById('selection__price').innerHTML = '&dollar;90/mo';
      break;
    case 4:
      document.getElementById('selection__name').innerHTML = 'Advanced (Yearly)';
      document.getElementById('selection__price').innerHTML = '&dollar;120/mo';
      break;
    case 5:
      document.getElementById('selection__name').innerHTML = 'Pro (Yearly)';
      document.getElementById('selection__price').innerHTML = '&dollar;150/mo';
      break;
    default:
      break;
  }
...
function selectionOptions(option) {
  switch (option) {
    ...
    case 1:
    case 2:
      document.querySelector('#option-0 .option__price').innerHTML = '+&dollar;1/mo';
      document.querySelector('#option-1 .option__price').innerHTML = '+&dollar;2/mo';
      document.querySelector('#option-2 .option__price').innerHTML = '+&dollar;2/mo';
      break;
    case 3:
    case 4:
    case 5:
      document.querySelector('#option-0 .option__price').innerHTML = '+&dollar;10/yr';
      document.querySelector('#option-1 .option__price').innerHTML = '+&dollar;20/yr';
      document.querySelector('#option-2 .option__price').innerHTML = '+&dollar;20/yr';
      break;
  }
}
